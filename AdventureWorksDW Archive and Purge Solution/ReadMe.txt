...
CREATE CONFIGURATION ENTRIES.sql -->
 (Update the desired Batch Size and Retention period before execute the script) 
 a. This script would clone AdventureWorksDW2017 database and name it as “AdventureWorksDW2017_Archive” database. 
...
“Archive Fact Data.dtsx” --> 
a. Copy the package to the drive b. Create a job from the SQL SERVER AGENT job to call the “Archive Fact Data.dtsx” and schedule the job if needed. 

Testing Instructions:
Open Package—Check the connections are pointed to the correct server
Update the desired BATCH_SIZE and RETENTION_PERIOD for each table according to the requirement
Check the row count of in all the tables in both AdventureWorksDW2017 database and archive database.
For further details refer below website http://www.myknowledgesharing.com/2019/11/how-to-implement-archive-and-purge.html
